                ...
                <div class="box">
                    ...
                    <?php if (isset($sukses)) {
                      ...
                      <div class="alert alert-success alert-dismissible">
                        ...
                        <h4><i class="icon fa fa-check"></i>Data foto berhasil di edit.
                      </div>
                      <?php
                    } ?>
                    <?php 
                        echo form_open_multipart('index.php/admin/gallery/simpanEdit'); 
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <textarea name="judul_foto" class="form-control"><?php echo $key['judul_foto']; ?></textarea>
                            <?php echo form_error('judul_foto', '<code> Tolong ! ', '</code>'); ?>
                        </div>
                        <div class="form-group">
                            <label>Deskripsi Foto</label>
                            <textarea name="deskripsi_foto" class="form-control" style="max-width: 1072px;"><?php echo $key['deskripsi_foto']; ?></textarea>
                        ...
                        <div class="form-group">
                            <label>Ganti Foto : <input type="file" name="file_foto"></label>
                            <?php echo $error; ?>
                        </div>
                        <div class="form-group">
                            <h5>Foto Sekarang :</h5>
                            <a href="<?php echo base_url('assets/uploads/gallery/'.$key['file_foto']); ?>" target="blank">
                                <img src="<?php echo base_url('assets/uploads/gallery/'.$key['file_foto']); ?>" style="max-width: 250px;">
                            </a>
                        </div>
                    </div>
