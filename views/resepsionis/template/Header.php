        ...
        <div class="region region-main-menu">
          <div class="tb-megamenu tb-megamenu-main-menu">
            <ul class="nav navbar-nav navbar-right">
              <li><a href="<?php echo base_url('index.php/resepsionis/resepsionis'); ?>"  title="Home">Home</a></li>
              <li><a href="<?php echo base_url('index.php/resepsionis/layanan'); ?>" title="Layanan">Layanan</a></li>
              <li><a href="<?php echo base_url('index.php/resepsionis/resepsionis'); ?>" title="Tanggapan Layanan">Tanggapan Layanan</a></li>
            </ul>
          </div>
        </div>
      </nav>
